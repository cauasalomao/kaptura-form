...
--
-- Por isso cada bloco abaixo usa `set local role kaptura_n8n` dentro de
...
-- ---------------------------------------------------------------------
-- LIMPEZA · rodar como postgres (o kaptura_n8n, corretamente, nao consegue)
-- ---------------------------------------------------------------------
